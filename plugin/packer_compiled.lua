...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-dap', 'staline.nvim', 'tex.nvim', 'nice-reference.nvim', 'which-key.nvim', 'nvim-bufferline.lua', 'nvim-lspconfig', 'kommentary', 'nvim-toggleterm.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
