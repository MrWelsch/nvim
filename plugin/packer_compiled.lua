...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-toggleterm.lua', 'nvim-dap', 'which-key.nvim', 'staline.nvim', 'tex.nvim', 'kommentary', 'nvim-lspconfig'}, { event = "BufEnter *" }, _G.packer_plugins)]]
