...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-cmp", "nvim-lsp-installer", "lspsaga.nvim" },
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'galaxyline.nvim', 'kommentary', 'nvim-treesitter', 'monokai-pro.nvim', 'nvim-lspconfig', 'vimtex', 'nvim-bufferline.lua', 'which-key.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
