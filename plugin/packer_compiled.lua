...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-dap', 'which-key.nvim', 'nvim-bufferline.lua', 'nvim-lspconfig', 'Comment.nvim', 'nvim-toggleterm.lua', 'tex.nvim', 'staline.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
