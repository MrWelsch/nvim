...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-dap', 'nvim-lspconfig', 'which-key.nvim', 'nvim-bufferline.lua', 'staline.nvim', 'tex.nvim', 'Comment.nvim', 'nvim-toggleterm.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
