...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-dap', 'nvim-bufferline.lua', 'nvim-lspconfig', 'nvim-toggleterm.lua', 'staline.nvim', 'tex.nvim', 'kommentary', 'which-key.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
