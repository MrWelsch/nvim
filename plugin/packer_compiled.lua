...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'staline.nvim', 'tex.nvim', 'nvim-lspconfig', 'which-key.nvim', 'nvim-toggleterm.lua', 'kommentary', 'nvim-bufferline.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
