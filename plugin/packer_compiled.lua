...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'Comment.nvim', 'nvim-lspconfig', 'staline.nvim', 'tex.nvim', 'nvim-dap', 'nvim-toggleterm.lua', 'nvim-bufferline.lua', 'which-key.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
