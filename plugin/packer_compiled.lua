...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  ["glow.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/opt/glow.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nice-reference.nvim"] = {
    config = { "require('plugins.references')" },
    loaded = true,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/start/nice-reference.nvim",
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'which-key.nvim', 'nvim-dap', 'nvim-bufferline.lua', 'Comment.nvim', 'nvim-toggleterm.lua', 'staline.nvim', 'tex.nvim', 'nvim-lspconfig'}, { event = "BufEnter *" }, _G.packer_plugins)]]
