...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'tex.nvim', 'nvim-lspconfig', 'which-key.nvim', 'nvim-bufferline.lua', 'nvim-toggleterm.lua', 'kommentary', 'staline.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
