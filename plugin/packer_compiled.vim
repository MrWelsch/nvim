...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'galaxyline.nvim', 'gruvbox-flat.nvim', 'kommentary', 'which-key.nvim', 'nvim-lspconfig', 'nvim-treesitter'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au ColorScheme * ++once lua require("packer.load")({'nvim-bufferline.lua', 'bracey.vim', 'git-blame.nvim', 'undotree', 'gitsigns.nvim', 'vimtex', 'lsp-rooter.nvim', 'nvim-bqf'}, { event = "ColorScheme *" }, _G.packer_plugins)]]
