return { 
    ...
    config = function()
        ...
        local leader_mappings = {
            ...
            f = {
                name = " FIND",
                f = {"<cmd>lua require('telescope.builtin').find_files(require('plugins.telescope'))<cr>",                          "󰈞 FILE"},
                ...
                p = {"<cmd>lua require'telescope'.extensions.projects.projects{}<cr>",                                              "󱈆 PROJECTS"},
