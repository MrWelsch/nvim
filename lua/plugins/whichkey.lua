	...
	config = function()
		...
		local leader_mappings = {
			...
			l = {
				name = " LSP",
				d = {
					"<cmd>lua require('telescope.builtin').diagnostics(require('plugins.telescope').document)<cr>",
					"󱪚 DOCUMENT DIAGNOSTICS",
				},
				-- D = {"<cmd>lua require('trouble').toggle('document_diagnostics')<cr>",                         "󱪚 TROUBLE DOCUMENT"},
				w = {
					"<cmd>lua require('telescope.builtin').diagnostics(require('plugins.telescope'))<cr>",
				...
				t = {
					...
					a = {
						"<cmd>:!terraform apply -auto-approve<cr>",
						" APPLY",
					},
				},
			},
			f = {
				...
				r = {
					"<cmd>lua require('telescope.builtin').oldfiles(require('plugins.telescope'))<cr>",
					"󰡦 RECENT FILES",
				},
				R = {
					"<cmd>lua require('telescope.builtin').registers(require('plugins.telescope'))<cr>",
					"󱝩 REGISTERS",
				},
				t = {
					"<cmd>lua require('telescope.builtin').live_grep(require('plugins.telescope'))<cr>",
					"󱘢 TEXT",
				},
				d = {
			...
			c = {
				...
				t = {
					"<cmd>lua require('telescope.builtin').colorscheme(require('plugins.telescope'))<cr>",
					" THEME",
				},
			},
			g = {
				...
				c = {
					"<cmd>lua require('telescope.builtin').git_branches(require('plugins.telescope'))<cr>",
					" BRANCHES",
				},
				l = {
