...
return require('packer').startup(function()
    ...
    -- TREESITTER
    use {"nvim-treesitter/nvim-treesitter", config = [[require('plugins.treesitter')]], run = "TSUpdate", event = "BufEnter", module = "nvim-treesitter"}
    ...
    -- GIT
    use {"lewis6991/gitsigns.nvim", config = [[require('plugins.gitsigns')]], requires = "nvim-lua/plenary.nvim", event = "ColorScheme"}
